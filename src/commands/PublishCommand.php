...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'artificer-localization-plugin:publish';
    ...
    public function fire()
    {
        if (file_exists(base_path().'/workbench/'.$this->package.'/')) {
            $this->call('config:publish', ['--path' => 'workbench/'.$this->package.'/src/config', 'package' => $this->package]);
            $this->call('asset:publish', ['--bench' => $this->package]);
        } else {
