...
class LocalizationPlugin extends AbstractPlugin
{
    ...
    {
        \Event::listen(['artificer.view.edit.before.title'], function ($field) {
...
//        });
        ...
        Event::listen(['artificer.view.head.styles'], function () {
            ?>
            <link rel="stylesheet" href="<?php echo asset(self::$assets_path.'css/flag-icon.min.css') ?>">
